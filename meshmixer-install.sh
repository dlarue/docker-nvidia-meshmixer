#!/bin/sh
# from: https://github.com/rimim/meshmixer_ubuntu_16/blob/master/install_meshmixer.sh
# https://github.com/rimim/meshmixer_ubuntu_16

sudo apt-get install libboost-dev libsuperlu4 libcgal-dev libminizip-dev dh-autoreconf
...
if [ ! -f tmp/meshmixer_2.9_amd64.deb ]; then 
  #wget http://openartist.org/debian/xenial64/meshmixer_2.9_amd64.deb
  cp /meshmixer_2.9_amd64.deb tmp/meshmixer_2.9_amd64.deb
fi
...
sudo cp -a $INSTALL_DIR/opt/* /opt
sudo cp -a $INSTALL_DIR/usr/* /usr
